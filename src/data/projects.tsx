...
export const projects: Project[] = [
  {
    ...
    stack: [
      ...
      { name: 'AntDesign', icon: <InlineSvg name="/tech/antdesign" /> },
      { name: 'WebSockets', icon: <InlineSvg name="/tech/websocket" /> },
      { name: 'Figma', icon: <InlineSvg name="/tech/figma" /> },
  ...
  },
  {
    ...
    stack: [
      ...
      { name: 'OpenStreetMap', icon: <InlineSvg name="/tech/openstreetmap" /> },
      { name: 'Leaflet', icon: <InlineSvg name="/tech/leaflet" /> },
    ],
