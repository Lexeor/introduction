...
const PanelBorders: FC<PanelBordersProps> = ({
  ...
  return (
    <div className="absolute inset-x-0 h-full pointer-events-none">
      {top && (
        <div
          className="absolute flex items-center justify-center w-full -top-8 h-8 z-31 bg-background-500 rounded-t-4xl cursor-pointer group pointer-events-auto"
          onClick={onTopClick}
        >
          <motion.div
            initial={{ opacity: 0 }}
      ...
      {bottom && (
        <div
          className="absolute flex items-center justify-center w-full -bottom-8 h-8 z-31 bg-background-500 rounded-b-4xl cursor-pointer group pointer-events-auto"
